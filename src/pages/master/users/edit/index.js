...
function Users(props) {
  ...
  const onSubmit = (data) => {
    ...
    typeof(data.company_id) == 'undefined'  && delete data.company_id 
    typeof(data.role_id)    == 'undefined'  && delete data.role_id
    api.put(`master/user/${id}`, {
      ...data
    },{
      headers: authHeader(), 
    })
          ...
          <Paper className={classes.card}>
            <Grid container direction="row">
                ...
                <Grid container direction="column" xs={4}>
                  <CustomSelector
                    width={'75%'}
                    value={values.company_id ? values.company_id : '' }
                    label="Empresa"
                    name="company_id"
                    inputRef={register}
                  ...
                  >
                    {values.company_id  &&
                      ...
                      <MenuItem key={1} value={values.company_id}>{values.corporate_name}</MenuItem>
